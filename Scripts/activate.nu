...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Alberto_Cime\Documents\epam course\task 1\app-flask\flask-palindrome'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Alberto_Cime\Documents\epam course\task 1\app-flask\flask-palindrome\Scripts\deactivate.nu'
